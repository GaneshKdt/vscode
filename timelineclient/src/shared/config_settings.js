const VERSION = '0.0.1'
const CHAT_API_KEY = '3188af863b45ee48f80292c154e498a5f'
const QUERY_TAT = '1'
const SIDEBAR_UPDATE_INTERVAL = 60000
const SIDEBAR_UPDATE_INTERVAL_FOR_UPCOMINGSESSIONS = 300000
...
const defaultConfig = {
    ...
    SIDEBAR_UPDATE_INTERVAL_FOR_UPCOMINGSESSIONS: SIDEBAR_UPDATE_INTERVAL_FOR_UPCOMINGSESSIONS,
    ...
    METTL_DEMO_EXAM_URL_WX : "https://tests.mettl.com/authenticateKey/2qyoc53b40", //updated link on 25Mar21
    METTL_DEMO_EXAM_URL_MSC : "https://tests.mettl.com/authenticateKey/33fso1beo0"
}
...
const localConfig = {
    ...
    ENVIRONMENT: 'LOCAL',
    RES_BASE : '/',
    SIDEBAR_UPDATE_INTERVAL: 100000000,
}
