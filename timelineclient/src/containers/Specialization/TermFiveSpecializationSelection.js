...
class TermFiveSpecializationSelection extends Component {
    ...
    blockHandler = (blockIndex, totalBlockInstance, minSequenceInRow, maxSequenceInRow) => {
        ...
        Array.from(Array(totalBlockInstance), (e, j) => {
            Array.from(Array(totalBlockInstanceSequenceCount), (e, k) => {
                ...
                this.props.termFiveSubject.map(subject => {    
    ...
    render() {
        return <>
            <Table responsive >
                <thead>
                    <tr>
                        <th width='8%' style={{fontSize:'1.2em', verticalAlign: 'middle'}}>Term V</th>
                            {
...
export default TermFiveSpecializationSelection;