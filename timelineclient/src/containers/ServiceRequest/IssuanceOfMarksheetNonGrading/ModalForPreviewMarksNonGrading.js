...
class ModalForPreviewMarksNonGrading extends Component{
              ...
              <>
                ...
                <Modal  show={this.props.show} onHide={this.props.handleModalClose} className="announcement-modal">
                  <Modal.Header closeButton>
                    <Modal.Title className="announcement-title " style={{fontSize:'16px'}}> &nbsp;MARKSHEET MARKS PREVIEW</Modal.Title>
                  </Modal.Header>
                  ...
                  <Row>
                      <Col md={12}>
                      <p style={{wordBreak: 'break-word'}}>**This is a system generated preview for Marksheet and cannot be used as Marksheet</p>
                      </Col>
                      </Row>    
                        ...
                        <tbody>
                            {this.props.previewData.marks.map(record => 
                                <tr key={record.subject}>
                                    ...
                                    <td>{record.teeScore}</td>
                                    <td>{record.iaScore}</td>
                                    <td>{record.total}</td>
                                    {/* {record.graceMarks ? 
...
export default ModalForPreviewMarksNonGrading