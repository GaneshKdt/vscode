...
import './IssuanceOfMarksheetNonGrading.css';
...
import ModalForPreviewMarks from './ModalForPreviewMarksNonGrading';
...
class IssuanceOfMarksheetNonGrading extends Component {
    constructor(props) {
        super(props);
    }
    state = {
    ...
    getClearedSemForStudent = () =>{
        ...
        axios.post(urls.apiUrl_exam + "getClearedSemForAStudent",
        {
                            ...
                            onClick: () => {
                                ...
                                axios.post(urls.apiUrl_studentPortals + "/checkMarksheetHistoryForMBAWX",
                                {
                                    ...
                                    //if(response.data.marksheetDetailAndAmountToBePaidList[0].amount > 0 ){
                                        ...
                                        //     message: 'Issuance of Marksheet SR already raised.',
                                        //     buttons: [
                                        //     {
                                        //         label: 'OK',
                                        //         onClick: () => {
    ...
    handlePreviewMarks = (evt) =>{
        ...
        axios.defaults.headers.post['Content-Type'] = false;
        axios.post(urls.apiUrl_exam + "/generateNonGradedMarksheetPreviewFromSR",
        body,
        ).then(response =>{
            //console.log(JSON.stringify(response));
            this.setState({
            ...
            <Card style={{maxWidth : "80%"}}>
                    ...
                    <Row>
                        <Col>
                            <Form className="forFormInSR"> 
                                ...
                                <Button variant="primary" id="addMarkssheetReq" onClick={this.addMarksheetRequest}>Add Marksheet Request</Button>
                                ...
                                <Table striped hover size="sm">
                                 ...
                                 <Form.Group as={Row} controlId="wantAtAddress">
                                        <Form.Check type="checkbox" label="I want Marksheet at my address (Shipping Charges INR. 100/-)" onChange={this.handleAddrConfirmation} />
                                </Form.Group> 
                    ...
                    <Card.Footer>
                        ...
                        {this.state.forward === true?
                            <Redirect to={{pathname:'/timeline/marksheetSummaryNonGrading' ,state:{responseData : this.state.responseData}}}  />
                        : null }
                    </Card.Footer>
                </Card>
...
export default connect(mapStateToProps)(analyticsManager(IssuanceOfMarksheetNonGrading))
