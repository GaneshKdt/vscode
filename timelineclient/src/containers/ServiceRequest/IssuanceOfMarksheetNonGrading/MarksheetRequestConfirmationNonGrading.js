...
class MarksheetRequestConfirmationNonGrading extends Component{
    state = {
    ...
    saveMarksheetRequest = () => {
        ...
        confirmAlert({
            ...
            message: 'Are you sure you want to request for this Marksheet? You can not make any changes after this step.',
            buttons: [
            {
                label: 'Yes',
                onClick: () => {
    ...
    callSaveApi = () =>{
        if(this.state.isRequestFree){
            ...
            //console.log("------ Save API called for Free Marksheet")
                ...
                // body is Multipart data to send to documents api
                        ...
                        axios.post(urls.apiUrl_studentPortals + "saveMarksheetAndPayment",body
                            ...
                            this.setState({
                                ...
                                // console.log("final ammount is "+this.state.amount);
    ...
    :null}
                        ...
                        <Col>
                            <Form className="forFormInSR"> 
                                ...
                                <Form.Group as={Row}>
                                    ...
                                    <Form.Row as={Row}>
                                            <Form.Label><b>Note: First Marksheet request for given Exam Year-Month-Term is free. Any subsequent requests for same Marksheet will be considered as a duplicate request and  Service Request fees of INR. 500/- will be charged for the same</b></Form.Label>
											<Form.Label><b>Note: If you are issuing duplicate Marksheet due to any other reason, please submit a copy of Indeminity bond and FIR for the same</b></Form.Label>
                                    </Form.Row>
                                </Form.Group>
                    ...
                    : null}
                        <Form.Group>
                            <div className="forButtons">
                                {this.state.srData.totalAmountToBePayed && parseInt(this.state.srData.totalAmountToBePayed) === 0 ?
                                    <Button variant="primary" id="submit" onClick={this.saveMarksheetRequest}>Request Marksheet</Button>
                        ...
                        {this.state.forward === true?
                            ...
                            <Redirect to={{pathname:'/timeline/srCreated' ,state:{id: this.state.responseDataForSave.id, reqType : this.state.responseDataForSave.serviceRequestType,
                            description: this.state.responseDataForSave.description, sapId : this.state.responseDataForSave.sapId}}}  />
                            : 
                            <Redirect to={{pathname:'/timeline/srCreated' ,state:{error: this.state.responseDataForSave.error, reqType : this.state.responseDataForSave.serviceRequestType,
                            }}}  />
...
export default analyticsManager(MarksheetRequestConfirmationNonGrading)