...
const CITY_COUNTRY_CODE_FROM_PIN = new ConfigUrls().api.getAddressDetailsFromPinCode
...
return(
        <>
            ...
            <Form.Group as={Row} controlId="houseNoName">
                ...
                <Col sm="8">
                    <Form.Control type="textarea" name="houseNoName" maxLength="30" value={props.houseNoName} onChange={props.handleTextChange}/>
                    {props.houseNoName && props.houseNoName.length > 0 ?
                        <p>{ `${props.houseNoName.length} out of 30 characters.` }</p>
                    : null}
            ...
            <Form.Group as={Row} controlId="street">
                ...
                <Col sm="8">
                    <Form.Control type="textarea" name="street"  maxLength="35" value={props.street} onChange={props.handleTextChange}/>
                    {props.street && props.street.length > 0 ?
                        <p>{ `${props.street.length} out of 35 characters.` }</p>
                    : null}
                    {props.errors["street"] !== "" ?
            ...
            <Form.Group as={Row} controlId="locality">
                ...
                <Col sm="8"> 
                    <Form.Control type="textarea" name="locality"  maxLength ="35" value={props.locality} onChange={props.handleTextChange}/>
                    {props.locality && props.locality.length > 0 ?
                        <p>{ `${props.locality.length} out of 35 characters.` }</p>
                    : null}
