...
class DuplicateStudyKit extends Component {
    constructor(props) {
        super(props);
    }
    state = {
        sapId : this.props.student.sapid,
        serviceRequestType : 'Duplicate Study Kit',
        back : false,
        forward : false,
        sem : "",
        responseData : [],
        ...
        studentData : this.props.student,errors : {},
        fieldsToValidate : null,
        error : null,
    
    }
    saveDuplicateStudyKit = (evt) => {
        //axios--
                    ...
                    confirmAlert({
                        ...
                        buttons: [
                        {
                            ...
                            onClick: () => {
                                ...
                                // axios.post(urls.apiUrl_studentPortals + "/saveDuplicateStudyKit",
                                // {
                                //     sem : this.state.sem,
                    ...
                    <Card.Footer>
                        <Form.Group>
                            <div className="forButtons">
                                <Button variant="primary" id="submit" onClick={this.saveDuplicateStudyKit.bind(this)}>Save & Proceed to Payment</Button>
...
export default connect(mapStateToProps)(analyticsManager(DuplicateStudyKit))