...
import SRStatusPage from './SRStatusPage';
...
class SRStatusSuccess extends Component {
    ...
    componentDidMount() {
        console.log("=====>SRStatusSuccess Page")
    ...
    render() {
        if(this.state.reqType === "Subject Repeat MBA - WX") {
            return (
                <SRStatusPage 
                    trackId = {this.state.trackId}
                                    ...
                                    <>
                                        ...
                                        <div className="mx-auto d-flex align-items-center mt-4">
                                            <ButtonToolbar>
                                                ...
                                                { this.state.reqType == 'Change in Specialisation' ?
                                                    <LinkContainer to={{ pathname: '/timeline/electiveSelection', 
                                                        state: { serviceRequest: true } }} className="mx-1">
                                                        <Button variant="primary" className="mx-1">
                                                            Proceed to Specialization Selection
                                                        </Button>
                                                    </LinkContainer> :
                                                    <LinkContainer to='/timeline/selectSR' className="mx-1">
                                                        <Button variant="primary" className="mx-1">
