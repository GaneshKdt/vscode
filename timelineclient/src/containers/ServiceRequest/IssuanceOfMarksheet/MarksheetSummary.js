...
class MarksheetSummary extends Component {
    constructor(props) {
        super(props);
    }
    state = {
    ...
    render(){
        return(
            ...
            <Card style={{maxWidth : "80%"}}>
                    <Card.Body>
                        <Card.Header>Gradesheet Summary </Card.Header>
                        <Table striped hover size="sm">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Gradesheet Details</th>
                                            <th>Charges</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <Card.Footer>
                        ...
                        {this.state.forward === true?
                            ...
                            <Redirect to={{pathname:'/timeline/marksheetRequestConfirmation' ,state:{responseData : this.state.responseData}}}  />
...
export default analyticsManager(MarksheetSummary)
