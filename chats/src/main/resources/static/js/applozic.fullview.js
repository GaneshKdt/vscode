    ...
    function Applozic(appOptions) {
        ...
        _this.stoptimer = function() {
            ...
            $applozic(d).on("click", ".mck-message-reply", function() {
                ...
                document.getElementById('conversation-section').style.cssText = 'position: relative; height:85% ;';
                document.getElementById('mck-sidebox-ft').style.cssText = ' position: relative; bottom: 9.5rem;';
            });
